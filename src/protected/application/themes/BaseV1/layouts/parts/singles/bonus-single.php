<div ng-controller="RegistrationFieldsController" ng-init="data.canEvaluate = <?php echo $canEvaluate ? 'true' : 'false'; ?>; data.evaluationData = <?php echo htmlspecialchars(json_encode($evaluationData), ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <li ng-repeat="field in data.bonusFields" 
                ...
                <div style="display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap;">
                    ...
                    <select 
                        ...
                        <option value="true" ng-selected="data.evaluationData['b2_' + field.id] === 'true'">Sim</option>
                        <option value="false" ng-selected="data.evaluationData['b2_' + field.id] === 'false'">Não</option>
                    </select>
                </div>
            </li>
        </ul>
