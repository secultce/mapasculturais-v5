        ...
        <tr>
            <td colspan='5'>
                ...
                <span ng-if="!usingRegistrationsFilters() && data.registrationsAPIMetadata.count > 1">                    
                    {{data.registrations.length}} <?php \MapasCulturais\i::_e("inscrições.");?>
                </span>
<!--                <span ng-if="usingRegistrationsFilters() && data.registrationsAPIMetadata.count > 1">{{data.registrations.length}} -->
                <?php //\MapasCulturais\i::_e("inscrições encontradas com os filtros selecionados.");?><!--</span>-->
            </td>
        </tr>
