...
<?php
    ...
    function includeAngularEntityAssets($entity) {
        ...
        $this->localizeScript('moduleOpportunity', [
            ...
            'correctErrors' =>  i::__('Corrija os erros indicados abaixo.'),
            'registrationSent' =>  i::__('Inscrição enviada. Aguarde tela de sumário.'),
            'confirmRemoveValuer' => i::__(Utils::getTermsByOpportunity('Você tem certeza que deseja excluir o avaliador?', $entity)),
            'confirmReopenValuerEvaluations' => i::__(Utils::getTermsByOpportunity('Você tem certeza que deseja reabrir as avaliações para este avaliador?', $entity)),
