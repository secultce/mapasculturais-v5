...
$maxNumberLinks = env('MAX_NUMBER_LINKS') ? (int) env('MAX_NUMBER_LINKS') : 20;
...
<button ng-click="entity[fieldName] = addLinkField(entity[fieldName], <?= $maxNumberLinks ?>)" class="btn btn-primary"><?php i::_e('adicionar') ?></button>
