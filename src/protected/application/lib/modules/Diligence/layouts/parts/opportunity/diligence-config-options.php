...
?>
    <div class="registration-fieldset" ng-controller="OpportunityController">
        ...
        <p class="field-use-diligence">
            ...
            <span
                class="<?= $opportunity->publishedOpinions || $opportunity->publishedRegistrations ?: 'js-editable' ?> editable-click"
        ...
        <p class="field-diligence-days" style="display:none">
            ...
            <span
                class="<?= $opportunity->publishedOpinions || $opportunity->publishedRegistrations ?: 'js-editable' ?>"
