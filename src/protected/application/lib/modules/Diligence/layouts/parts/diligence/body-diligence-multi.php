...
?>
<div id="diligence-diligent-body" hidden>
                ...
                <div>
                    <div style="font-size: 14px; padding: 10px; margin-bottom: 10px;">
                        ...
                        <label for="">
                            ...
                            <?php //Condição para mostrar na página o assunto
                        ...
                        <span style="font-size: 12px; font-weight: 700; color: #404040;">
                            <?php echo Carbon::parse(
                                $diligenceAndAnswers[0]->sendDiligence
                            )->isoFormat("LLL"); ?>
                        </span>
                    </div>
                    <?php if (
                        !is_null($diligenceAndAnswers[1]) &&
                        $diligenceAndAnswers[1]->status ==
                        ...
                        <div style="font-size: 14px; background-color: #F5F5F5; padding: 10px;">
                            ...
                            <?php
                            $files = DiligenceRepo::getFilesDiligence(
                                $diligenceAndAnswers[1]->diligence->id
                            );

                            foreach ($files as $file) {
                                echo '
                                    <p style="margin-bottom: 10px;">
                                        <a href="/arquivos/privateFile/' .
                                    $file["id"] .
                            ...
                            <span style="font-size: 12px; font-weight: 700; color: #404040;">
                                <?php echo Carbon::parse(
                                    $diligenceAndAnswers[1]->createTimestamp
                                )->isoFormat("LLL"); ?>
                            </span>
                        </div>
                    <?php else: ?>
    ...
    <div class="div-diligence" id="div-diligence">
        ...
        <?php //Array para marcar como confirmado a opção


        isset($diligenceAndAnswers[0])
